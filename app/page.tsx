  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="mx-auto max-w-screen-xl w-full px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t bg-background">
            <div className="mx-auto max-w-screen-xl w-full px-4 py-4 space-y-3">
              {user && (
                <Link
                  href="/my-activity"
              ...
              <div className="flex flex-col justify-center space-y-6">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground text-base sm:text-lg md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Track, rate, and share your experiences with skincare products. Build your personal skincare
                    database.
                  </p>
                </div>
          ...
          <div className="mx-auto max-w-screen-xl w-full">
            <div className="relative overflow-hidden rounded-xl sm:rounded-2xl">
              ...
              <div className="absolute inset-0 flex items-center">
                <div className="w-full px-4 sm:px-8 mx-auto max-w-screen-xl">
        ...
        <section className="border-t bg-muted/40">
          <div className="py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-screen-xl w-full">
              ...
              <div className="mx-auto max-w-5xl gap-4 sm:gap-6 py-8 sm:py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <footer className="border-t py-4 sm:py-6 md:py-8">
        <div className="mx-auto max-w-screen-xl w-full px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-between gap-4 md:flex-row">
          <div className="flex items-center gap-2">
            <div className="rounded-full bg-emerald-100 p-1">
